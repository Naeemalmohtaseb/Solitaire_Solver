...
impl PimcActionStats {
    ...
    pub(crate) fn record(&mut self, value: f32, outcome: SolveOutcome, deterministic_nodes: u64) {
        self.visits += 1;
...
pub fn recommend_move_pimc(
    ...
    let evaluator = PimcEvaluator::new(
        pimc_config,
    ...
    let solver = DeterministicSolver::new(evaluator.deterministic_config);
