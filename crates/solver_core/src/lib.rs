...
pub use config::{
    DeterministicSolverConfig, ExperimentConfig, RootParallelConfigOverride, SearchConfig,
    SolverConfig,
};
pub use core::{
...
pub use deterministic_solver::{
    evaluate_fast, solve_bounded, solve_exact, strategic_move_score, BoundedSolveResult,
    DeterministicBound, DeterministicHashKey, DeterministicSearchConfig, DeterministicSearchStats,
    DeterministicSolver, DeterministicTt, DeterministicTtConfig, DeterministicTtEntry,
    DeterministicTtValue, EvaluatorWeights, ExactSolveResult, FastEvalResult,
    OpenCardRecommendation, ProofStatus, SolveBudget, SolveMode, SolveOutcome, StrategicMoveScore,
};
pub use error::{SolverError, SolverResult};
pub use experiments::{
    balanced_benchmark, balanced_vnet_benchmark, belief_uct_default, belief_uct_late_exact,
    compare_experiment_presets_on_suite, compare_experiment_presets_on_suite_with_progress,
    compare_named_presets_on_suite, compare_oracle_reference_results, compare_oracle_results,
    compare_vnet_leaf_mode_on_suite, evaluate_oracle_cases, experiment_preset_by_name,
    ...
    run_autoplay_benchmark_with_progress, run_autoplay_paired_comparison,
    run_autoplay_paired_comparison_with_progress, run_autoplay_repeated_comparison,
    run_autoplay_repeated_comparison_with_progress, run_regression_pack, save_oracle_case_pack,
    save_oracle_local_evaluation, save_regression_pack, AutoplayBenchmarkConfig,
    ...
    NoopProgressReporter, OracleCase, OracleCasePack, OracleCaseProvenance, OracleCaseResult,
    OracleComparisonRecord, OracleComparisonSummary, OracleEvaluationConfig, OracleEvaluationMode,
    OracleLocalEvaluation, OracleMismatchCount, OracleMismatchKind, OracleReferenceResult,
    OracleReferenceResultSet, PairedComparisonResult, PairedComparisonSummary, PairedDealResult,
    PimcActionStats, PimcActionValue, PimcConfig, PimcEvaluationMode, PimcEvaluator,
    PimcRecommendation, PimcWorldBatch, PlannerBackend, PresetComparisonEntry,
    PresetComparisonSummary, PresetRankingMetric, ProgressCommandKind, ProgressEvent,
    ProgressReporter, RegressionCase, RegressionCaseData, RegressionCaseKind,
    RegressionCaseProvenance, RegressionCaseResult, RegressionExpectation, RegressionMismatch,
    RegressionMismatchCount, RegressionMismatchKind, RegressionObserved, RegressionPack,
    RegressionPackMetadata, RegressionPackSummary, RegressionRunConfig, RegressionRunResult,
    RepeatedComparisonResult, RepetitionSummary, VNetImpactSummary, EXPERIMENT_PRESET_NAMES,
    ORACLE_CASE_SCHEMA_VERSION, ORACLE_RESULT_SCHEMA_VERSION, REGRESSION_PACK_SCHEMA_VERSION,
};
pub use late_exact::{
