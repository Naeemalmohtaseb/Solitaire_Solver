...
mod tests {
    ...
    fn waste_to_foundation_legality_and_application() {
        ...
        let transition =
            apply_atomic_move(&mut state, AtomicMove::WasteToFoundation, None).unwrap();
    ...
    fn apply_undo_symmetry_for_representative_move_types() {
        ...
        stock_advance.stock = CyclicStockState::from_parts(
            vec![card("Ac"), card("2c"), card("3c")],
            3,
            0,
            0,
        ...
        stock_recycle.stock = CyclicStockState::from_parts(
            vec![card("Ac"), card("2c"), card("3c")],
            0,
            1,
            0,
